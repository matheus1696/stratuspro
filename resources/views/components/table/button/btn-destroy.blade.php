<a href="#" 
    onclick="event.preventDefault(); if(confirm('Tem certeza de que deseja excluir este item?')) { document.getElementById('delete-form').submit(); }"
...
<form id="delete-form" action="{{ $href }}" method="POST" style="display: none;">
    @csrf
    @method('DELETE')
</form>